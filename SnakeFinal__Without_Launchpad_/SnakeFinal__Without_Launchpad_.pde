ArrayList snake;     
int snackSize = 1, positionX = 0, positionY = 0, direction = 0, columns = 30, rows = 16, step = 50, score = 0, last_time, tempo;     
long lastStep = 0;  
boolean start = false, loose = false, Player_Sam = false, Player_Johann = false, Head_Johann = false, Head_Sam = false, burger = false, flag = true;
